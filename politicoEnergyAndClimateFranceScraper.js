...
async function politicoEnergyAndClimateFranceScraper() {
  ...
  try {
    ...
    const articles = await page.evaluate(() => {
      return Array.from(document.querySelectorAll('div.card__content')).map(card => {
    ...
    const filename = 'politicoEnergyAndClimateFrance.json';
...
politicoEnergyAndClimateFranceScraper();

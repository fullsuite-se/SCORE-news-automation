...
async function politicoLaborScraper() {
  const browser = await puppeteer.launch({ headless: false, slowMo: 50 });
  const page = await browser.newPage();
  const url = 'https://www.politico.com/labor-news-updates-analysis';

  try {
    console.log('Navigating to Politico Labor page...');
    ...
    const filename = 'politicoLaborScraper.json';

...
/**
 * Next.js API route handler for scraping South African Reserve Bank search results.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Add a short delay to ensure dynamic content loads, if any
    ...
    const articles = await page.evaluate(() => {
      ...
      items.slice(0, 10).forEach(item => {
        ...
        // Assuming date is the second span element within resultListItem__content

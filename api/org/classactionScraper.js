...
export default async function (req, res) {
  ...
  let browser;
  const url = 'https://www.classaction.org/news';
  ...
  try {
    ...
    await page.waitForSelector('article.w-100', { timeout: 10000 });
    ...
    const articles = await page.evaluate(() => {
      ...
      const blocks = [
        ...document.querySelectorAll('div.fl-l.w-100.w-40-l.mb4.mb0-l'),
        ...document.querySelectorAll('article.w-100.w-50-l.mv4')
      ];

      blocks.forEach(block => {
        const linkEl = block.querySelector('a.link.near-black.hover-dark-blue');
        const dateEl = block.querySelector('span.sans-serif.ttu.tracked.f7.pr3.black-50, span.sans-serif.ttu.tracked.f8.pr2.black-50');

...
export default async function (req, res) {
  ...
  let browser;
  const url = 'https://www.banktrack.org/partner_news';
  ...
  try {
    ...
    await page.waitForSelector('div.article.item.article_article.partner', { timeout: 10000 });

    const articles = await page.evaluate(() => {
      const articleNodes = document.querySelectorAll('div.article.item.article_article.partner');
      const seen = new Set();
      const results = [];

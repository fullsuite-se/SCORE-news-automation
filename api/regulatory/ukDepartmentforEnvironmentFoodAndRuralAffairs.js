...
export default async function (req, res) {
  ...
  const url = `https://www.gov.uk/search/all?content_purpose_supergroup%5B%5D=guidance_and_regulation&content_purpose_supergroup%5B%5D=policy_and_engagement&order=updated-newest&organisations%5B%5D=department-for-environment-food-rural-affairs&page=1&parent=department-for-environment-food-rural-affairs`
  const articles = [];

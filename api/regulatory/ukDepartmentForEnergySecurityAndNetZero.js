...
export default async function (req, res) {
  ...
  const url = `https://www.gov.uk/search/all?parent=department-for-energy-security-and-net-zero&order=updated-newest&content_purpose_supergroup%5B%5D=guidance_and_regulation&content_purpose_supergroup%5B%5D=policy_and_engagement&organisations%5B%5D=department-for-energy-security-and-net-zero`
  const articles = [];

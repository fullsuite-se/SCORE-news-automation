// pages/api/scrape-meti-press.js
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('Navigating to METI Press page...');
    await page.goto(url, { waitUntil: 'domcontentloaded', timeout: 90000 }); 

    console.log('Waiting for an extra 5 seconds for full load...');
    ...
    const articles = await page.evaluate(() => {
      ...
      Array.from(articleNodes).slice(0, 10).forEach(dl => { 

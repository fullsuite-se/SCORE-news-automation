...
export default async function (req, res) {
  ...
  const url = `${baseUrl}/legal-library/browse/cases-proceedings?sort_by=field_date&items_per_page=20&field_mission%5B29%5D=29&field_consumer_protection_topics=1408&search=&field_competition_topics=All&field_federal_court=All&field_industry=All&field_case_status=All&field_enforcement_type=All&search_matter_number=&search_civil_action_number=&start_date=&end_date=`;

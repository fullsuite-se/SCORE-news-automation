...
export default async function (req, res) {
  ...
  let browser;
  const baseUrl = 'https://www.gov.uk/search/guidance-and-regulation?organisations%5b%5d=department-for-energy-security-and-net-zero&parent=department-for-energy-security-and-net-zero';

...
/**
 * Next.js API route handler for scraping IAI Global SAK Updates.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Wait for the 'div.col-md-12' element to ensure content is present
    ...
    const articles = await page.evaluate(() => {
      ...
      containers.forEach(container => {
        ...
        // Clean up the date string if it contains '- SAK Update'

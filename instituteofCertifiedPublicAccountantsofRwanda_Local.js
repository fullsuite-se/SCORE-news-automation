// pages/api/scrape-icparwanda.js
...
/**
 * Next.js API route handler for scraping ICPAR Rwanda search results.
...
export default async function handler(req, res) {
  ...
  const url = 'https://icparwanda.com/?s=sustainability';
  ...
  try {
    ...
    console.log('Waiting for articles selector (article)...');
    // Wait for the 'article' element to ensure content is present
    ...
    const articles = await page.evaluate(() => {
      ...
      const results = [];
      const seenUrls = new Set(); // To avoid potential duplicates if any

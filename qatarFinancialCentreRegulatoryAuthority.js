...
/**
 * Next.js API route handler for scraping QFCRA search results for "Sustainability".
  ...
  try {
    ...
    const articles = await page.evaluate(() => {
      ...
      containerSections.forEach(section => {
        ...
        // Only add articles with valid title, URL, and date, and if not a duplicate
